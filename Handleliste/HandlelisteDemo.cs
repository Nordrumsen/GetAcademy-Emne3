namespace Handleliste
{
    internal class SimpleShoppingCartDemo
    {
        ...
        private static void Buy(string productName, int count, List<string> myShoppingCartProducts,
            List<int> myShoppingCartCounts)
        {
        ...
        private static void ShowCart(string[] productNames, int[] productPrices, List<string> myShoppingCartProducts,
            List<int> myShoppingCartCounts)
        {
